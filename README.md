...
[Design Process] Done by Nigel Lim
...
index.html (Home Page) Done by Nigel Lim
...
ITCourse.html (Information Technology Page) Done by Nigel Lim
...
Moving on with displaying the core module for 'Year 1,2,3' I have created a expanding grid. With this it could store and list the relevant modules for each of the year just by clicking on the Year 1, Year 2, Year 3 column.

In the table that will be consisting of Career Propects, Further Studies and Course Overview. Given a suitable setting for the table, the style section is where I store the table setting such as like the padding ,border, text-alignment, width.
...
ITMinigame.html (Information Technology Game Page) Done by Nigel Lim
...
We created a canvas game where student will control a green object and try to overcome and avoid the grey boxes floating towards them. With a instruction below it will allows stuents who play the game to have a detailed information about how the game should be played and operated.



CSFCourse.html (Cybersecurity & Digital Forensics) Done by Leon
...
IMCourse.html (Immersive Media Page) Done by Leon
...
IMMinigame.html (Immersive Media Game Page) Done by Leon
...
CampusMap.html (Campus Map Page) Done by Nigel Lim
...
AboutUs.html (About Us) Done by Nigel Lim
